...
_Оновлено 2026-07-08: Виправлено права доступу для ролі User у мобільному додатку (вирішення інцидентів), виправлено цілісність відображення графіків (збереження OrganizationId з IoT пристрою та корекція БД), реалізовано від'ємні температури на клієнтах, усунуто помилки десеріалізації (Malformed JSON) при відновленні пароля та підтвердженні email на мобільному клієнті._
