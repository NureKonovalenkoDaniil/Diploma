...
export const medicineApi = {
  ...
  getById: (id: number) =>
    api.get<MedicineDto>(`/api/medicine/${id}`).then((r) => r.data),
  ...
  receive: (id: number, data: { quantity: number; description?: string; relatedLocationId?: number; storageLocationId?: number }) =>
    api.post<MedicineDto>(`/api/medicine/${id}/receive`, data).then((r) => r.data),
  issue: (id: number, data: { quantity: number; description?: string; relatedLocationId?: number }) =>
    api.post<MedicineDto>(`/api/medicine/${id}/issue`, data).then((r) => r.data),
  dispose: (id: number, data: { quantity: number; description?: string; relatedLocationId?: number }) =>
...
export const conditionApi = {
  getAll: () =>
    api.get<StorageConditionDto[]>('/api/storagecondition').then((r) => r.data),
}
...
export const locationApi = {
  getAll: () =>
    api.get<StorageLocationDto[]>('/api/storagelocation').then((r) => r.data),
  getById: (id: number) =>
...
export const incidentApi = {
  getAll: () =>
    api.get<StorageIncidentDto[]>('/api/storageincident').then((r) => r.data),
  getActive: () =>
    api.get<StorageIncidentDto[]>('/api/storageincident/active').then((r) => r.data),
  getById: (id: number) =>
...
export const lifecycleApi = {
  getAll: () =>
    api.get<MedicineLifecycleEventDto[]>('/api/medicinelifecycle').then((r) => r.data),
  getByMedicine: (medicineId: number) =>
    api.get<MedicineLifecycleEventDto[]>(`/api/medicinelifecycle/medicine/${medicineId}`).then((r) => r.data),
  addEvent: (data: Omit<MedicineLifecycleEventDto, 'eventId' | 'medicineName' | 'relatedLocationName' | 'performedBy' | 'performedAt'>) =>
...
export const notificationApi = {
  getAll: (role?: string) =>
    api.get<NotificationDto[]>(`/api/notification${role ? `?role=${role}` : ''}`).then((r) => r.data),
  getUnread: () =>
    api.get<NotificationDto[]>('/api/notification/unread').then((r) => r.data),
